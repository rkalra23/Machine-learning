...
################# building normal Knn model without tunning ########
...
print('Time complexity for KNN PCA base model is', end-start,' seconds')
process = psutil.Process(os.getpid())
print('Memory consumed for KNN PCA base model is',process.memory_info().rss, 'bytes')
...
print('Time complexity for KNN PCA optimized model is', end-start,' seconds')
process = psutil.Process(os.getpid())
print('Memory consumed for KNN PCA optimized model is',process.memory_info().rss, 'bytes')
